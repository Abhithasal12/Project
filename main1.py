...
btn_open = tk.Button(root, text="(", command=lambda: add_to_calculation("("), width=5, font= ("arial",14),background="yellow")
btn_open.grid(row=5, column=1)

btn_close = tk.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, font= ("arial",14),background="yellow")
btn_close.grid(row=5, column=3)

btn_clear = tk.Button(root, text="C", command=clear_filed , width=11, font= ("arial",14),background="yellow")
btn_clear.grid(row=6, column=1, columnspan=2)

btn_eual = tk.Button(root, text="=", command=evaluate_calculation, width=11, font= ("arial",14),background="yellow")
btn_eual.grid(row=6, column=3, columnspan=2)
